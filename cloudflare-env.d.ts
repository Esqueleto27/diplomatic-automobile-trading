/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 63d72ce9b8010840aa22e33b8d65a117)
...
interface __BaseEnv_CloudflareEnv {
	...
	RATE_LIMITER_CONTACTO: RateLimit;
	...
	WHATSAPP_NUMBER_SEGUROS: string;
	WORKER_SELF_REFERENCE: Fetcher /* diplomatic-automobile-trading */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "R2_PUBLIC_URL" | "AUTH_SECRET" | "WHATSAPP_NUMBER" | "WHATSAPP_NUMBER_SEGUROS">> {}
}
