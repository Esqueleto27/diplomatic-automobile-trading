  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="grid size-14 place-items-center rounded-full bg-gold text-gold-foreground shadow-glow outline-none transition-all duration-200 hover:-translate-y-0.5 hover:bg-gold-strong hover:shadow-glow-hover focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-4 focus-visible:ring-offset-background"
      >
        <svg
          viewBox="0 0 24 24"
          fill="currentColor"
